...
You don't need to manually adjust the spacing, figure numbers, or page numbers. Details like this are all specified in the document preamble, and \LaTeX will handle the rest.
