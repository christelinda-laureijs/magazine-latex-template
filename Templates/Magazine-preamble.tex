...
\usepackage{lettrine}
%\renewcommand{\LettrineFontHook}[4]{lines=3,findent=0.42em,nindent=0em,lraise=0.05}

\newcommand{\Q}{\bigskip\bfseries\lettrine[lines=2,findent=0.42em,nindent=0em,lraise=.15]{Q}}
\newcommand{\A}{\bigskip\bfseries\lettrine[lines=2,findent=0.42em,nindent=0em,lraise=0.05,depth=0]{A}}
