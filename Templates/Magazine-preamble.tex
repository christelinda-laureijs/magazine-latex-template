...
{\begin{center}\BIG\itshape\fontspec{CormorantGaramond-Light.ttf}}
{\end{center}}
...
% TODo: Find way to define font stored in local repository
% TODO: Set author to cormoant to enable boldness
% TODO find way to have line underline full column
% TODO Find way to have references use different spacing
% TODO: Find out how to have a full-bleed picture behind section 
